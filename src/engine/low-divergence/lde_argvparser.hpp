...
namespace lde_CommandLineProcessing
{
...
using namespace std;
using namespace lde_CommandLineProcessing;
...
bool lde_CommandLineProcessing::isDigit(const char& _char)
{
...
bool lde_CommandLineProcessing::isValidOptionString(const string& _string)
{
...
bool lde_CommandLineProcessing::isValidLongOptionString(const string& _string)
{
...
bool lde_CommandLineProcessing::splitOptionAndValue(const string& _string,
...
string lde_CommandLineProcessing::trimmedString( const std::string & _str )
{
    // no string no work
    if(_str.length() == 0)
        return _str;
...
bool lde_CommandLineProcessing::expandRangeStringToUInt( const std::string & _string,
        std::vector< unsigned int > & _expanded )
{
    list<string> tokens;
    // split string by delimiter
...
std::string lde_CommandLineProcessing::formatString(const std::string& _string,
        unsigned int _width,
