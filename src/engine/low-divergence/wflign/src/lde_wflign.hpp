...
#include "lde_wflign_alignment.hpp"
...
namespace lde_wflign {
    namespace wavefront {
        ...
        public:
            ...
            // WFlign parameters
            int lde_wflign_mismatch_score;
            int lde_wflign_gap_opening_score;
            int lde_wflign_gap_extension_score;
            float lde_wflign_max_mash_dist;
            int lde_wflign_min_wavefront_length;
            int lde_wflign_max_distance_threshold;
            uint64_t lde_wflign_max_len_major;
            uint64_t lde_wflign_max_len_minor;
            int erode_k;
            int64_t chain_gap;
            ...
            // WFling affine
            void lde_wflign_affine_wavefront(
                    const std::string& query_name,
                    char* const query,
...
typedef struct {
    // WFlign
    lde_wflign::wavefront::WFlign* lde_wflign;
    // Parameters
    int pattern_length;
    int text_length;
    uint16_t step_size;
    ...
    std::vector<std::vector<lde_rkmh::hash_t>*>* query_sketches;
    std::vector<std::vector<lde_rkmh::hash_t>*>* target_sketches;
